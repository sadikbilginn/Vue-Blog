    ...
    <div class="card">
        <div class="card-body">
            <div class="d-flex justify-content-between pb-2 mb-2">
                ...
                <div>
                    <router-link :to="{name: 'posts'}" class="btn btn-success">Geri</router-link>
                </div>
            </div>
            ...
            <form @submit.prevent="updatePost" enctype="multipart/form-data">
                <div class="form-group mb-2">
                    <label>Başlık</label><span class="text-danger"> *</span>
                ...
                <div class="form-gorup mb-2">
                    <label>Resim</label><span class="text-danger"> *</span>
                ...
                <button type="submit" class="btn btn-primary mt-4 mb-4">Güncelle</button>
